...
Label(frameNumpad,text="Voer het aantal in:",font=('Arial',20),height=5).grid(row=0,column=0, columnspan = 2)
labelTotaal = Label(frameNumpad,text='',font=('Arial',25,'bold'))
labelTotaal.grid(row=0,column=2)
...
Button(frameNumpad,text="Klaar",font=('Arial',20),command=exitRoot,bg='lightgreen',height=5,width=10).grid(row=4, column=2)
